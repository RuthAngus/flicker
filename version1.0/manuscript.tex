...
% 	\log_{10}(F_8), \sigma = \sqrt{\sigma_{\rho}^2 + \gamma F_8}\right),
	\log_{10}(\rho_\star) \sim \mathcal{N} \left(\mu = \alpha_\rho +
    \beta_\rho \log_{10}(F_8), \sigma^2 = \sigma_\rho^2 \right),
\end{equation}
\label{eq:rho}
and
\begin{equation}
...
% 	\sigma = \sqrt{\sigma_g^2 + \zeta F_8}\right).
	\log_{10}(g) \sim \mathcal{N} \left(\mu = \alpha_g + \beta_g
    \log_{10}(F_8), \sigma^2 = \sigma_g^2 \right).
\end{equation}
\label{eq:logg}
...
\begin{equation}
	\log_{10}(\rho_\star) \sim \mathcal{N} \left(\mu = \alpha_\rho +
    \beta_\rho \log_{10}(F_8), \sigma = \sqrt{\sigma_{\rho}^2 +
...
scatter varied as a function of \logg or \rhostar.
...
We tested a likelihood function which accounts for 2-D uncertainties but does
...
only accounts for the uncertainties on the flicker measurements, so instead
