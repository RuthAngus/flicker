...
The median values of the model parameters differed by around $0.05 \sigma$
for the $\alpha$ and $\beta$ parameters, by $0.3 \sigma$ for $\sigma_\rho$
and by 0.8 $\sigma$ for $\sigma_g$.
...
The marginal posterior PDFs of the model parameters for \rhostar are shown in
...
RA would also like to thank the anonymous referee for their excellent
suggestions, SAMSI institute and the other members of the SAMSI {\it Kepler}
exoplanet statistics working groups.
