...
\begin{figure}
\begin{center}
\includegraphics[width=8.4cm,angle=0,clip=true]{../figs/rho_vs_flicker_simple.pdf}
\caption{
...
\begin{figure}
\begin{center}
\includegraphics[width=8.4cm,angle=0,clip=true]{../figs/logg_vs_flicker_simple.pdf}
\caption{
$\log(g)$ vs. flicker.
